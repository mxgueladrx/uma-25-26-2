...
**Knowledge Discovery (KDD)**: proceso completo (selección, limpieza, transformación de datos, data mining, interpretación y uso del conocimiento).
...
**Datos**: colección de objetos y atributos.

**Valores del atributo**: números o símbolos asignados a cada atributo.
