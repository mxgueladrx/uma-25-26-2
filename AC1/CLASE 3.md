...
## ==Preguntas del examen como en los apuntes \*==
...
- **Tratamiento de valores perdidos:**
	...
	- **Imputación basada en modelos**: basándose en información disponible, predecir que valor va en el hueco
		...
		- **Máxima verosimilitud (EM)**: probabilístico. El algoritmo encuentra valores que mejor encajarían para que la distribución total de los datos sea lo más coherente posible
